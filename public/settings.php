<?php
define('C_REST_CLIENT_ID','app.681c8540695902.90549112');//Application ID
define('C_REST_CLIENT_SECRET','692fMScXA870FM7INaTc0qlFAV9kz51FcxlhDWhe3En7ANvb7S');//Application key
// or
